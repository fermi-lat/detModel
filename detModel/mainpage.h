...
/*! \mainpage package detModel

 This package provides an interface to a generic detector description
 or model suitable for use by an application such as Simulation 
 or Reconstruction.  
